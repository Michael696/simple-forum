...
export default function ForumItem({id}: { id: Id }) {
    ...
    return (
        <div className='main-forum__item'>
            ...
            <div className='main-forum__cell-constant flex-center-vertical'>themes:{forum.themeCount}</div>
            <div className='main-forum__cell-constant flex-center-vertical'>posts:{forum.postCount}</div>
